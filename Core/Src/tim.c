...
void MX_TIM1_Init(void)
{
  ...
  if (HAL_TIM_PWM_ConfigChannel(&htim_pixclock, &sConfigOC, TIM_CHANNEL_1) != HAL_OK)
  {
    Error_Handler();
  }
  sConfigOC.Pulse = 48;
  if (HAL_TIM_PWM_ConfigChannel(&htim_pixclock, &sConfigOC, TIM_CHANNEL_2) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  HAL_TIM_MspPostInit(&htim_pixclock);
